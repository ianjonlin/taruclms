<x-layout bodyClass="bg-gray-200">
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-100"
            style="background-image: url('https://images.unsplash.com/photo-1526285759904-71d1170ed2ac?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80');">
                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-body">
                                <div class="d-flex flex-column justify-content-center">
                                    ...
                                    <span class="text-black text-lg text-center mt-4">LEARNING MANAGEMENT SYSTEM</span>
                                </div>
