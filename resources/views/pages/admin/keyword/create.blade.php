                    ...
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                <h4 class="mb-3">Add New Keyword</h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method='POST' action='{{ route('keyword.store') }}'>
                            ...
                            <div class="row justify-content-center">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border border-2 p-2" name="value"
                                        required>
                                </div>

                                <div class="d-flex flex-row-reverse">
                                    <a class="btn bg-gradient-dark my-4 mb-2" href="{{ route('keyword.index') }}"
